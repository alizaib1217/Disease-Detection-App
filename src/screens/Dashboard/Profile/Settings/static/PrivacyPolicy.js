    ...
    return (
      <Container>
        <AppHeader
          ...
          body={ItemText.Privacy({color: "#fff"})}
        />
        <Content style={{paddingVertical: 10, paddingHorizontal: 5}}>
          <ResponsiveText style={{textAlign: "justify"}}>
            ...
            {"\n"}
            Disease Detection ("us", "we", or "our") operates the Disease Detection mobile application (the "Service").
            {"\n"}
            This page informs you of our policies regarding the collection, use, and disclosure of personal data when
            you use our Service and the choices you have associated with that data. Our Privacy Policy for Disease
            Detection is created with the help of the Free Privacy Policy Generator.
            {"\n"}
            ...
            Use of Data
            Disease Detection uses the collected data for various purposes:
            {"\n"}
            {"\n"}
            ...
            If you are located outside Pakistan and choose to provide information to us, please note that we transfer
            the data, including Personal Data, to Pakistan and process it there.
            {"\n"}{"\n"}
            Your consent to this Privacy Policy followed by your submission of such information represents your
            agreement to that transfer.
            {"\n"}{"\n"}
            Disease Detection will take all steps reasonably necessary to ensure that your data is treated securely and
            ...
            Disclosure Of Data{"\n"}{"\n"}
            Legal Requirements{"\n"}{"\n"}
            Disease Detection may disclose your Personal Data in the good faith belief that such action is necessary to:
            {"\n"}{"\n"}
            To comply with a legal obligation
            To protect and defend the rights or property of Disease Detection
            ...
            By email: alizaib1217@gmail.com
          </ResponsiveText>
        </Content>
